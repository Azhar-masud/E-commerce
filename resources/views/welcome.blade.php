                ...
                <div class="row align-items-center">
                    <div class="col-lg-3">
                        <div class="brand-wrap">
                            <img class="logo" src="{{ url('frontend/images/logo-dark.png') }}">
                ...
                <div class="col-md-9">
                    ...
                    <div class="owl-init slider-main owl-carousel" data-items="1" data-dots="false" data-nav="true">
                        <div class="item-slide">
                            <img src="{{ url('frontend/images/banners/slide1.jpg') }}">
                        </div>
                        <div class="item-slide rounded">
                            <img src="{{ url('frontend/images/banners/slide2.jpg') }}">
                        </div>
                        <div class="item-slide rounded">
                            <img src="{{ url('frontend/images/banners/slide3.jpg') }}">
                        </div>
                    </div>
                    <!-- ============== main slidesow .end // ============= -->
                </div>
                ...
                <div class="col-md-3">
                    <div class="card mt-2 mb-2">
                        <figure class="itemside">
                            <div class="aside">
                                <div class="img-wrap img-sm border-right"><img src="{{ url('frontend/images/items/3.jpg') }}"></div>
                            </div>
